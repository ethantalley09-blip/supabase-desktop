...
export function FatigueGuard({ orgId, projectId }) {
    ...
    return (<div className="space-y-3 rounded-lg border border-orange-200 bg-white p-5">
      ...
      {checkFatigue.isError && <p className="text-sm text-red-600">{checkFatigue.error.message}</p>}

      {checkFatigue.data && (<div className={`rounded-md border p-3 text-sm ${checkFatigue.data.fatigue_risk_score > 0.6
