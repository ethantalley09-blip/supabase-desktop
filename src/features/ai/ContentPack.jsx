...
export function ContentPack({ project, defaultLanguage }) {
    ...
    const email = pack?.email_subject || pack?.email_body
    ...
    return (<div className="space-y-3 rounded-lg border border-violet-200 bg-white p-5">
      ...
      <textarea rows={2} className="w-full rounded-md border border-neutral-300 px-3 py-2 text-sm" placeholder="What's the message? e.g. Early voting starts Monday — remind supporters to make a plan and find their polling place." value={brief} onChange={(e) => setBrief(e.target.value)}/>
...
function Channel({ label, text, project, defaultLanguage }) {
    ...
    return (<div className="space-y-2 rounded-md border border-neutral-200 bg-neutral-50 p-3">
