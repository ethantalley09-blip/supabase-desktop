...
describe('campaign command center calculations', () => {
    ...
    it('reports concrete GOTV blockers', () => {
        const voter = { id: '1', contact_status: 'active', lat: null, lng: null, territory_id: null, ballot_status: 'requested' };
        const readiness = buildGotvReadiness([voter], [{ assigned_to: null }]);
