...
function TableDoc({ title, rows }: { title: string; rows: Record<string, unknown>[] }) {
...
export async function exportPdf(filename: string, title: string, rows: Record<string, unknown>[]) {
