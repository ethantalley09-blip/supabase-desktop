...
export function MajorDonorLadder({ orgId, projectId, donors }) {
    ...
    return (<div className="space-y-3 rounded-lg border border-amber-200 bg-white p-5">
      ...
      {escalations && escalations.length > 0 && (<div className="divide-y divide-amber-100 rounded-md border border-amber-100">
          {escalations.slice(0, 5).map((e) => (<div key={e.id} className="space-y-1.5 p-3">
