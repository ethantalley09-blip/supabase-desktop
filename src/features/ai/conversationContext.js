...
export const FOLLOW_UP_PROMPTS = ['Why does that matter?', 'Show your math.', 'What data are you missing?'];
...
export function buildFollowUpInstructions(question, history) {
...
export function assessConfidence(turf) {
...
export function buildScopeLine(turf, fundraising) {
