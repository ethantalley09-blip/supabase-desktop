...
import { detectCanvasserFatigue, type VisitForFatigue } from './canvasserFatigue';
...
function visit(id: string, name: string, hours: number, outcome: 'contacted' | 'no_answer'): VisitForFatigue {
