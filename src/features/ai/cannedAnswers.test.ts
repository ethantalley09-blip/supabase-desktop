...
import {
  answerAverageDonation,
  answerBallotsOutstanding,
  answerComplianceProgress,
  answerContactsLogged,
  answerFundraisingTotal,
  answerGeocodingBacklog,
  answerTopCity,
  answerUnassignedTerritories,
  answerVoterUniverse,
  buildCannedAnswers
} from './cannedAnswers';
...
const geocode = (over: Partial<GeocodeHealth> = {}): GeocodeHealth => ({
  total: 100,
  mapped: 80,
  noAddress: 2,
  unattempted: 10,
