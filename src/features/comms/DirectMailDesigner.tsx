...
export function DirectMailDesigner({ orgId, projectId }: { orgId: string; projectId: string }) {
  ...
  return (
    <div className="space-y-3 rounded-lg border border-emerald-200 bg-white p-5">
      ...
      <textarea
        ...
        placeholder="What's the mailer about? e.g. GOTV postcard reminding early voters where their polling place is."
        value={brief}
      ...
      {draft.data && (
        <div className="rounded-md border border-emerald-100 bg-emerald-50 p-4 text-center">
