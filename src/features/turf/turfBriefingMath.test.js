...
import { buildBriefingSnapshot, classifyPersuadability, heatmapWeight, voterParty } from './turfBriefingMath';
const voter = (over) => ({
    id: 'v1',
    project_id: 'p1',
    data: {},
...
describe('heatmapWeight', () => {
    ...
    it('stays within [0,1] for every mode', () => {
        ...
        for (const mode of ['density', 'persuadability', 'fundraising', 'staleness']) {
