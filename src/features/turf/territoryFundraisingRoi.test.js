...
const voter = (id, territoryId) => ({ id, territory_id: territoryId });
const territory = (id, name) => ({ id, name });
const visit = (voterId) => ({ voter_id: voterId });
const donation = (voterId, cents) => ({ voter_id: voterId, amount_cents: cents });
